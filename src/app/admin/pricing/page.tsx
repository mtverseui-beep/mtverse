  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-muted-foreground">Control weekday and weekend offers, included products, standard-price fallback, campaign copy, and email content.</p>
      </div>
