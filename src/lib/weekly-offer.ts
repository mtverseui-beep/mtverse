...
export function normalizeWeeklyOfferSettings(input: Partial<WeeklyOfferSettings> | null | undefined): WeeklyOfferSettings {
  return {
    ...
    individualTemplatePriceUsd: cleanPrice(input?.individualTemplatePriceUsd, 7, [7]),
    uiLibraryPriceUsd: cleanPrice(input?.uiLibraryPriceUsd, 7, [7]),
